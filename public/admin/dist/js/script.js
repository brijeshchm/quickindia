...
function updateKeywordSellCount(id,THIS){
	var $this = $(this);
	if(id!=''){
		$.get(
			"/developer/keyword_sell_count/update_keyword_sell_count/"+id,
			function(response,status){
				if(response.status){
					//$('#updateChildCategoryModal .modal-body').html(response.msg);
					$('#updateKeywordSellCountModal input[name="id"]').val(response.keywordSellCount.id);
					$('#updateKeywordSellCountModal input[name="name"]').val(response.keywordSellCount.name);
					$('#updateKeywordSellCountModal input[name="count"]').val(response.keywordSellCount.count);
					$('#updateKeywordSellCountModal input[name="cat1_price"]').val(response.keywordSellCount.cat1_price);
					$('#updateKeywordSellCountModal input[name="cat2_price"]').val(response.keywordSellCount.cat2_price);
					$('#updateKeywordSellCountModal input[name="cat3_price"]').val(response.keywordSellCount.cat3_price);
					$('#updateKeywordSellCountModal').modal();
				}
			}
		);
	}	
