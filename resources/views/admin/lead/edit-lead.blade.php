<?php echo View::make('admin.header'); ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Lead</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
					...
					<form class="form-horizontal lead_form" role="form" method="POST" action="{{ url('/developer/lead/add-lead') }}" novalidate autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
								<select class="form-control location city select2-single-city" name="city_id">
                                    ...
                                    <option value="{{$city->id}}" @if ($city->id== old('city_id'))
                                    selected="selected"	
                                    @else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="email" class="form-control" name="email"  value="{{ old('email',(isset($edit_data)) ? $edit_data->email:"")}}" placeholder="Enter Email">
                            </div>
                        </div>
