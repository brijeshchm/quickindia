...
<head>
  <meta charset="utf-8">
  <title>IIT Entrance Examp</title>
            ...
            <nav class="navbar navbar-default"> 
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
				  ...
				  <li>
                    <a class="page-scroll" href="#Entrance_Exam">IIT Entrance</a>
                  </li>
                  <li>
...
.landing {
    ...
    min-height: 780px;
    position: relative;
    background-image: url(../landing/img/iit-entrance-exam.jpg);
    background-repeat: no-repeat;
 ...
 .query{
  ...
  <div class="landing">
      <div class="searchform">
						<h1>IIT Entrance Exam Coaching</h1>
            ...
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					<h4><a href="javascript:void(0)" class="banner_botton">IIT & JEE preparation </a></h4>			 
					</div><div class="icon"><i class="fab fa-java"></i></div><p>Nowadays, several students prefer online courses to physical classrooms for competitive exams like IIT JEE. These students get to experience two major phenomena: the ability of personalization and therefore the easy learning from home. Would you agree that as a student your learning needs may vary from the person sitting next to you? have you ever stopped to think whether or not these needs are being catered to in an exceedingly physical coaching center, where you have got to compete with 100 other students, first to induce a seat of your choice, then to induce the eye of your teacher? Also, all this must happen at a time that’s convenient for your teacher, not you..</p>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">JEE Training </a></h4>			 
					</div><div class="icon"><i class="fab fa-php"></i></div><p>In contrast, choosing online IIT JEE preparation courses will be rather empowering. Consider this: you'll be able to pick an idea that meets your specific needs. you'll study the maximum amount or as little as you wish on a selected day. you'll be able to keep things interesting and lively by watching video lessons about concepts that you just just read. you'll be able to appear for periodic tests to determine your exam preparedness. And, you'll ask your queries to out subject material experts 24/7 who will go back to to you within the shortest span of your time. So, while studying online for IIT JEE, it's you who takes charge of the training process and not the schooling teacher..</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
