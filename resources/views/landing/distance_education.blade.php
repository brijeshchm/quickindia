            ...
            <nav class="navbar navbar-default"> 
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
				  ...
				  <li>
                    <a class="page-scroll" href="#Entrance_Exam">Distance Education</a>
                  </li>
                  <li>
...
.landing{
	...
	min-height:656px;
	position:relative;
	background-image: url(../landing/img/distance_education.jpg);
            ...
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					<h4><a href="javascript:void(0)" class="banner_botton">BCA</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Always expert in understanding computers, enhance that knowledge and get drift yourself in the vast network of computers. Bachelor in computer application will help you to catch that drift. We have aligned with many colleges and institutes that provide distance learning for you so that you can get trained with the best available in the market. Enroll with us now.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">MCA</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Already a graduate, but want to proceed with your career to grow more and to upgrade your resume in computers, well this is the best degree you can opt for in distance learning. Maters in Computer application will help you to proceed on the journey of computers more quickly and will make you eligible for the top-notch companies looking for certified candidates.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">B.Ed</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Want to enroll in your career in teaching, bachelors of education are the best platform for that. We have all the basic and advanced forms of training to get you selected in the preferred education platform along with the free demo classes for you. Join us to know more.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">B.Tech</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Bachelors in technology is a skill-oriented course, the aspirant who is looking for distance learning graduation in B. Tech can opt for us for getting trained for the entrance test as we provide full assistance along with guidance from the best counselors so you can be a part in changing the technology for the better good.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">M.Ed</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>This distance learning postgraduate degree helps you to develop skills for counseling, school psychology, and administration. It is simply a way to upgrade your career and to make the most out of it. The requirement for admission is an entrance test that we can assist with. Join us to start making your career through a Masters of Education.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">B Com </a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Want to pursue Bachelors in Commerce but confused from where to start. No worries, we provide complete assistance in providing you best institute, college or university for you to develop managerial skills and to understand terms like finance, management, accounts and tax related topics.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
