            ...
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					</div><div class="icon"><i class="fas fa-campground"></i></div><p>Want to learn 3D animation, but confused about how to get started, Don’t worry, we have the solution for you. quickindia is a platform that manages all the top institutes for providing education to the aspirants looking for the animation course. Join us and know more about Autodesk MAYA and know the future prospects of it.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 border-line formleftBlock">
				 ...
				 <div class="heading-txt">Why Fill This Form?</div>
                    <ul class="whyChoose">
                        ...
                        <li><span><img src="<?php echo asset('client/images/icon-1.png'); ?>"></span>E-24, Third Floor, Sector-3, Noida, 201301, Email:- info@quickindia, Phone:-7011310265, Website:- www.quickindia.com</li>
                    </ul>
                </div>
