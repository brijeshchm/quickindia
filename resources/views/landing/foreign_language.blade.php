            ...
            <nav class="navbar navbar-default"> 
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
				  ...
				  <li>
                    <a class="page-scroll" href="#Entrance_Exam">Foreign Language</a>
                  </li>
                  <li>
...
.landing{
	...
	min-height:656px;
	position:relative;
	background-image: url(../landing/img/language_banner.jpg);
 ...
 .event-content.head-team h4 {
  ...
  <div id="home" class="landing">
      <div class="searchform">
						<h1>Foreign Language Training</h1>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="section-headline text-center">
            <h2>Foreign Language Training</h2>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="tab-content ">
            <div class="tab-pane active" id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					<h4><a href="javascript:void(0)" class="banner_botton">French Language</a></h4>			 
					</div><div class="icon"><i class="fab fa-renren"></i></div><p>As the French language is the second most studied language and learning this language can widen up your career scope along with enhancing your mind. We understand this because we have provided candidates proper training with the top institutes and they are now placed in the best in the company.</p>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">German Language</a></h4>			 
					</div><div class="icon"><i class="fas fa-flag"></i></div><p>Want to get connected with the people across the world and want to add an advantage to your higher education than enroll with us to learn German language course. We provide the best institute for you to gain skills and to have better job opportunities..</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">Spanish Language</a></h4>			 
					</div><div class="icon"><i class="fas fa-flag"></i></div><p>Open the doors of your world by learning the Spanish language, engage yourself in exploring and gratifying the experience after learning Spanish. To get started to enroll your name with us and lets us find the best institute for you along with the free demo classes.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">Jaipnees Language</a></h4>			 
					</div><div class="icon"><i class="fa fa-circle"></i></div><p>Are you looking to opt for a translator field or you want to learn Japanese for opening a gateway to explore, we have a solution for it. We at quickindiaprovide the appropriate course according to your needs along with the best institute so you can learn and earn at the best.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">Chinese Language</a></h4>			 
					</div><div class="icon"><i class="far fa-star"></i></div><p>China has many languages among them the best and the most popular language is Mandarin. As it is spoken not only in china it is also getting one of the most growing languages, get enrolled with us and know how you can get this course done and what are the best institutes provide learning in mandarin.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">Spoken English</a></h4>			 
					</div><div class="icon"><i class="fas fa-flag-usa"></i></div><p>Being a universal language English learning is the most important course which everyone should opt for. We researched the market and found out the finest and the perfect training institutes that can help you grow the skills of the language so you will be open to fly anywhere in the world concerning job, travel or any expedition.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
            ...
            <div class="tab-pane" id="university">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">NDA 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Want to learn mathematics and general ability to clear NDA, join the force with us, we provide you coaching and all the relevant information you needed to be in it.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">CDS 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Join military force get yourself trained for the UPSC exam to join CDS( Common Defense Service) we have placed many and still placing students inthe best coaching center. Never stop yourself for the country.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">RRB 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-train"></i></div><p>Railway recruitment board NTPC exams,  prepare yourself and get into the biggest railway network in the world. Get your form filled, and rest upon us to provide you information and coaching from the best centers..</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">SSC 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Want to make your career in SSC to join ministries and government organization. Prepare for CGL. We provide the best way to institutes for you so you can mark success in your life. Choose quickindia.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">BANK PO</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Want to indulge in Banking and Finance, you are at right spot,, we help provide you training with best institute which have zero fail results.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">IAS 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Looking for IAS coaching, look no further, we provide best coaching platform for you so success never runs away from you. Get you aim of being in civil services done with proper training.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				</div>		
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">PCS 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Provincial civil service exam from the public service commission of India, know your eligibility and important dates along with the information for institutes who provide the coaching for clearance.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">UPSC 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Central service examinations for those who are looking for services in Group A and Group B of central services. This exam helps you to get a government job, as we all know it needs hard work to get it clear. quickindia helps you in that by providing the best coaching to you from our best centers.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">BPSC 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-institution"></i></div><p>Bihar public service commission, this exam is created by the Constitution of India for the selection for civil services job, so if you are looking for a civil services career, contact us so we can prepare you for the exam by finding the best preparation center for you.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">GRE</a></h4>			 
					</div><div class="icon"><i class="fa fa-book"></i></div><p>Graduated but need a higher degree for more opportunities, Look for GRE application online and let us find you a perfect place for getting your coaching done in Delhi NCR. We help you get admission for master and doctoral degree.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">GMAT</a></h4>			 
					</div><div class="icon"><i class="fa fa-book"></i></div><p>Being an MBA is all you need, Well opt foe GMAT exams as it will help you to clear gateways of universities you look for, get the best coaching tips from us and clear the exams.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">IELTS</a></h4>			 
					</div><div class="icon"><i class="fa fa-book"></i></div><p>Want to pass the IELTS exam, well here we provide you best institutes where you can get trained for the exam, get better at listening, reading, writing and speaking.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">TOEFL</a></h4>			 
					</div><div class="icon"><i class="fa fa-book"></i></div><p>Get supervised in learning English according to the need of the TOEFL exam. Get best results along with certification to fly around the world. Get best guidance for clearing the exam and best coaching institute for studying.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">SAT</a></h4>			 
					</div><div class="icon"><i class="fa fa-book"></i></div><p>Get supervised in learning English according to the need of the TOEFL exam. Get best results along with certification to fly around the world. Get best guidance for clearing the exam and best coaching institute for studying.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
           ...
           <div class="tab-pane" id="LawEntrance">
              <div class="tab-inner">
			   <div class="col-md-4 col-sm-4 col-xs-12">
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">DU LLB 2020 </a></h4>			 
					</div><div class="icon"><i class="fa fa-balance-scale"></i></div><p>University level tests conducted annually for aspirants looking for a 3year course in LLB from DU university. Get your computer based coaching done from coaching institutes provided by us for best results.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">Law Entrance </a></h4>			 
					</div><div class="icon"><i class="fa fa-balance-scale"></i></div><p>Get your career in Law, almost 21 national universities and 43 other institutes wait for you. Get your CLAT clear as we provide the best route for you for best coaching you need.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">LLB 2020 </a></h4>			 
					</div><div class="icon"><i class="fa fa-balance-scale"></i></div><p>Undergraduate Law degree for aspirants looking future in Law platform, LLB will help you to be in the system and to understand how the law works. Get indulge in best course, we help you provide the best institute needed.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">CLAT 2020 </a></h4>			 
					</div><div class="icon"><i class="fa fa-balance-scale"></i></div><p>Common entrance exam for law, get yourself selected by best Law college, get help in training for the entrance exam with us. As we are best in providing you perfect coaching center, according to your need.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
			...
			<!--end -->
           <div class="tab-pane" id="MBAEntrance">
              <div class="tab-inner">
				<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">UGC Net</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Achieve success in the UGC net exam, looking for future in post assistant professor. We know institutes who have successfully coached many aspirant along with the success reports.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">HR Management </a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Achieve success in the UGC net exam, looking for future in post assistant professor. We know institutes who have successfully coached many aspirant along with the success reports.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">MBA Entrance </a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Are you preparing for entrance exams for MBA? We offer institutes which are best in providing the training, CAT, MAT, XAT, NMAT, SNAP, ATMA, GMAT and others. So no need to find the best and get confused cause we already know the best institutes you should opt for better preparation.</p>
					<div class="course_mark course_free"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
           ...
           <div class="tab-pane" id="PharmacyEntrance">
              <div class="tab-inner">
            <div class="col-md-4 col-sm-4 col-xs-12">
				<div class="single-awesome-project">
				<div class="awesome-img">
				<a href="javascript:void(0);"><img src="{{asset('landing/img/portfolio/6.jpg')}}" alt="" /></a>
				<div class="add-actions text-center">
				<div class="project-dec">
				<a class="venobox" data-gall="myGallery" href="{{asset('landing/img/portfolio/6.jpg')}}">
				<h4>GPAT 2020</h4>
				<span>GPAT</span>
			...
			<div class="single-awesome-project">
			<div class="awesome-img">
			<a href="javascript:void(0);"><img src="{{asset('landing/img/portfolio/5.jpg')}}" alt="" /></a>
			<div class="add-actions text-center">
			<div class="project-dec">
			<a class="venobox" data-gall="myGallery" href="{{asset('landing/img/portfolio/5.jpg')}}">
			<h4>MAHACET 2020</h4>
			<span>MAHACET</span>
			</a>
			</div>
