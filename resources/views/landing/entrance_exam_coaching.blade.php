...
<head>
  <meta charset="utf-8">
  <title>Entrance Exam Coaching</title>
            ...
            <nav class="navbar navbar-default"> 
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
				  ...
				  <li>
                    <a class="page-scroll" href="#Entrance_Exam">Entrance Exam</a>
                  </li>
                  <li>
...
.landing{
	...
	min-height:656px;
	position:relative;
	background-image: url(../landing/img/Quickindia_banner.jpg);
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="tab-menu">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li >
                <a href="#engineering" role="tab" data-toggle="tab">Engineering Entrance Exams</a>
              </li>
              <li class="active">
            ...
            <div class="tab-pane " id="engineering">
              <div class="tab-inner">
				...
				<div class="single-awesome-project">
					...
					<h4><a href="javascript:void(0)" class="banner_botton">IIT JEE</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>IIT JEE is a joint entrance exam for all 7 zones of IIT conducted by the joint admission board. Improve your skills and know the in-depth knowledge for clearing the entrance exam for us. We are dedicated for your success and for that we provide the best coaching center for you.</p>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">UPSEE</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>UPSEE is an entrance test conducted by Dr. APJ Abdul Kalam technical university for the admissions in engineering institutions. Find your path with us as we will help you to get trained before the exams and to crack it successfully.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">GATE 2020</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Graduate aptitude test for engineering, A test conducted to test the various subjects of science and engineering. Let us help you to build a comprehensive understanding of these subjects by getting you trained in the best training center.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">COMEDK</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Preparing for the COMEDK undergraduate entrance test, a test for engineering and architecture. Many institutes provide coaching in COMEDK but how to choose the best, here comes Quickindia; we help candidates to find the perfect spot for getting trained in best coaching centers.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">BCECE</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>BCECEB - Bihar Combined Entrance Competitive Examination Board an exam conducted for those who seek admissions in Medical, Engineering, and Agriculture. the exam needs knowledge of the desired field and if you are looking for the perfect place to get yourself trained.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
				...
				<div class="single-awesome-project">
					<div class="awesome-img">					
					<div class="inner-box">	<div class="event-content head-team">
					<h4><a href="javascript:void(0)" class="banner_botton">WBSEE</a></h4>			 
					</div><div class="icon"><i class="fa fa-graduation-cap"></i></div><p>Want to get enrolled in West Bengal Board of Secondary Education, well this is the best time. Quickindia provides end to end support for WBSEE admissions. Don’t miss the opportunity many have already enrolled time for you to take action.</p>
					<div class="course_mark course_free trans_200"><a href="javascript:void(0)" class="banner_botton">Enquiry Now</a></div>
					</div>				 
				</div>
				</div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 border-line formleftBlock">
				 ...
				 <div class="heading-txt">Why Fill This Form?</div>
                    <ul class="whyChoose">
                        ...
                        <li><span><img src="<?php echo asset('client/images/icon-1.png'); ?>"></span>G-21, Third Floor, Sector-3, Noida, 201301, Email:- info@Quickindia, Phone:-9818798937, Website:- www.Quickindia.com</li>
                    </ul>
                </div>
