...
<script>
  gtag('event', 'conversion', {'send_to': 'AW-702944268/y2WDCJHL-b8BEIyomM8C'});
</script>
</head>
...
.landing{
	...
	min-height:656px;
	position:relative;
	background-image: url(../landing/img/thank-you-page-examples.jpg);
 ...
 .query{
  ...
  <div class="landing">
      <div class="searchform">
						<h1>Thank for submitting your query our experts will contact you soon</h1>
...
/* function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-702944268/y2WDCJHL-b8BEIyomM8C',
