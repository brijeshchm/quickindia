...
<div class="clearfix"></div>
		...
		<div class="review-list">
			  <div class="categoryBlock">
				...
				<div class="course-category-box">
					<a href="javascript:void(0)" class="banner_botton"><i class="fa fa-fw fa-graduation-cap" aria-hidden="true"></i>Management</a>				 
				...
				<div class="inner-category-div">			 
				<div class="course-category-box">
					<a href="javascript:void(0)" class="banner_botton"><i class="fa fa-fw fa-plus-square" aria-hidden="true"></i>Medical</a>				 
				...
				<div class="inner-category-div">			 
				<div class="course-category-box">
					<a href="javascript:void(0)" class="banner_botton"><i class="fa fa-fw fa-trophy" aria-hidden="true"></i>Engineering</a>				 
      ...
      <div class="image-left">
		<img src="{{asset('landingimage/entrance-image-Quickindia.jpg')}}" width="100%" title="Entrance Exam Coaching" alt="Entrance Exam Coaching">
            </div>
		...
		<h3><i class="fa fa-fw fa-graduation-cap" aria-hidden="true"></i><a href="javascript:void(0)" class="banner_botton">Management Education</a></h3>	<span class="dotted-border"></span>
		<h4>JEE Main 2020</h4>
		...
		<h4>JEE Advanced 2020</h4>
		<p>JEE Advanced exam is conducted to offer admission into bachelor’s, Integrated master’s & dual degree courses in all the IITs. These courses are offered in the area of engineering, sciences & architecture. It is regulated by the IITs on a rotation basis. Candidates can apply for this exam on a national level. Every year, the examination is organized in the month of May via online mode.</p>	
		<h4>GATE 2020</h4>
		...
		<h3><i class="fa fa-fw fa-trophy" aria-hidden="true"></i><a href="javascript:void(0)" class="banner_botton">MBA Entrance Exams</a></h3>
		<span class="dotted-border"></span>
		<h4>CAT 2020</h4>
		...
		<h3><i class="fa fa-fw fa-balance-scale" aria-hidden="true"></i><a href="javascript:void(0)" class="banner_botton">Law Entrance Exams</a></h3>
		<span class="dotted-border"></span>
		<h4>CLAT 2020</h4>
		...
		<h3><i class="fa fa-fw fa-balance-scale" aria-hidden="true"></i><a href="javascript:void(0)" class="banner_botton">University Level Entrance Exams</a></h3>
		<span class="dotted-border"></span>
		<h4>BITSAT 2020</h4>
