...
/* SEO */
		...
		Route::get('/developer/category/seo','KeywordController@indexCategotySEO')->middleware('auth');
	Route::get('/developer/categoryEdit/seo/{id}','KeywordController@editCategorySEO')->middleware('auth');
	Route::post('/developer/updateCategorySEO/seo/{id}','KeywordController@updateCategorySEO')->middleware('auth');
	
	Route::get('/developer/childcategory/seo','KeywordController@indexChildcategorySEO')->middleware('auth');
	Route::get('/developer/childcategoryEdit/seo/{id}','KeywordController@editChildcategorySEO')->middleware('auth');
	Route::post('/developer/updateChildcategorySEO/seo/{id}','KeywordController@updateChildcategorySEO')->middleware('auth');
...
/* Keyword Sell Count */
	...
	Route::post('/keyword_sell_count',[App\Http\Controllers\KeywordSellCountController::class,'store'])->middleware('auth');
	Route::get('/keyword_sell_count/delete/{id}',[App\Http\Controllers\KeywordSellCountController::class,'destroy'])->middleware('auth');
	Route::get('/keyword_sell_count/update_keyword_sell_count/{id}',[App\Http\Controllers\KeywordSellCountController::class,'edit'])->middleware('auth'); //ajax
	Route::post('/keyword_sell_count/update', [App\Http\Controllers\KeywordSellCountController::class,'update'])->middleware('auth');
/* Keyword Sell Count */
